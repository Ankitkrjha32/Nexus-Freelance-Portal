...
const PostJob = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-12 px-4 sm:px-6 lg:px-8 mt-14">
      <div className="max-w-4xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <div className="border border-gray-200 rounded-lg p-6 bg-gray-50">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Upload relevant job-related documents (PDF only, max 5MB)
              </p>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600 font-medium">
                      Click to upload job document (PDF)
                    </p>
            ...
            <div className="flex gap-4 pt-4">
              <button
                ...
                className="flex-1 px-6 py-4 border border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition text-lg"
              >
                Cancel
              </button>
              <button
                type="submit"
                className="flex-1 px-6 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-indigo-700 transition shadow-lg text-lg"
              >
                Post Job
              </button>
            </div>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          <h3 className="font-semibold text-blue-900 mb-2">
            📋 Tips for Creating a Great Job Post
          </h3>
          <ul className="text-sm text-blue-800 space-y-1">
            <li>• Be clear and specific about job responsibilities</li>
            <li>• Include required skills and qualifications</li>
            <li>• Provide accurate location and salary information</li>
            <li>• Write in a professional and engaging tone</li>
          </ul>
        </div>
      </div>
    </div>
