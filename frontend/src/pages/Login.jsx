...
const Login = () => {
    ...
    return (
        <div className="w-full flex justify-center items-center bg-gradient-to-br from-emerald-600 via-teal-600 to-green-600 min-h-screen px-4 py-8 relative overflow-hidden">
